<template>
    <div class="container mb-5">
        <div class="row col-12 justify-content-center">
            <h1 class="my-5 col-7">Crear Servicio</h1>
        </div>
        <div class="row col-12 justify-content-center">
            <div class="col-7">
...
<script>
    export default {
        ...
        mounted: async function(){
            ...
            this.form.user = cookieRes.user.userId;
            var provs = [];
        ...
        methods: {
            ...
            onUploadFile() {
                ...
                .then(res => {
                    ...
                    this.$axios.$post('/createService', this.form)
                })
                .catch(err => {
                    console.log(err);
                });
        ...
        onReset(event) {
            ...
            this.form.categoria = ''
            this.form.days= ''
            this.form.hourSelect= ''
            this.form.image= ''
            this.form.fromMorning= ''
            this.form.untilMorning= ''
            this.form.fromAfternoon= ''
            this.form.untilAfternoon= ''
